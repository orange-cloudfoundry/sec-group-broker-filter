...
public interface ServiceInstanceBindingRequestMapper {
    ...
    CreateServiceInstanceBindingRequest map(CreateServiceInstanceBindingRequest request);

    DeleteServiceInstanceBindingRequest map(DeleteServiceInstanceBindingRequest request);
