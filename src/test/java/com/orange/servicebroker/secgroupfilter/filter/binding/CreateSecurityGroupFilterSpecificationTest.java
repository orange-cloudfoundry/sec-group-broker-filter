...
public class CreateSecurityGroupFilterSpecificationTest {
    ...
    @Test
    public void validBindingRequest() throws Exception {
    ...
    @Test
    public void should_not_filter_if_not_a_PUT_method() throws Exception {
        HttpServletRequest request = new MockHttpServletRequest("GET", "/v2/service_instances/instance_id/service_bindings/binding_id");
        MockHttpServletResponse response = new MockHttpServletResponse();
        response.setStatus(HttpServletResponse.SC_CREATED);
    ...
    @Test
    public void should_not_filter_if_not_a_Binding_Route() throws Exception {
        HttpServletRequest request = new MockHttpServletRequest("PUT", "/v2/service_instances");
        MockHttpServletResponse response = new MockHttpServletResponse();
        response.setStatus(HttpServletResponse.SC_CREATED);
